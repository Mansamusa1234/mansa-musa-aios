...
export default function Analytics() {
  ...
  useEffect(() => {
    const readConsent = () => {
      try {
        ...
        setConsent(raw ? JSON.parse(raw) : { analytics: false, marketing: false });
      } catch {
    ...
    const onConsent = (event: Event) => {
      ...
      setConsent(detail ?? { analytics: false, marketing: false });
    };
  ...
  return (
    <>
      {analyticsAllowed && <Suspense fallback={null}><PageTracker /></Suspense>}
      ...
      {/* Mixpanel */}
      {analyticsAllowed && mixpanelToken && (
