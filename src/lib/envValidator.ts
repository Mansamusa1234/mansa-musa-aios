...
const ENV_MANIFEST: EnvVar[] = [
  ...
  { key: "STRIPE_PRICE_STARTER_ANNUAL", required: false, description: "Stripe annual price ID for Starter plan", group: "Stripe" },
  { key: "STRIPE_PRICE_PROFESSIONAL_ANNUAL", required: false, description: "Stripe annual price ID for Professional plan", group: "Stripe" },
  { key: "STRIPE_PRICE_ENTERPRISE_ANNUAL", required: false, description: "Stripe annual price ID for Enterprise plan", group: "Stripe" },
