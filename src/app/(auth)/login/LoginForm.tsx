...
export default function LoginForm({ showGithub, showGoogle, showMicrosoft, showApple }: Props) {
  ...
  if (phase === "totp") {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-[#070712] px-4 transition-colors">
            ...
            <form onSubmit={handleTotp} className="space-y-4" noValidate>
              ...
              <div>
                ...
                <input
                  ...
                  className={[inputBase, "text-center text-2xl font-mono tracking-[0.5em]"].join(" ")}
                  placeholder="000000"
              ...
              <div className="space-y-3">
                {showGithub && (
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-200 dark:border-white/8 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
                  >
