...
// Runs daily at 2pm. Pushes Starter users → Professional after 14 days.
// Only sends once per user (tracked via planUpsellSentAt).
      ...
      `<div style="font-family:sans-serif;max-width:580px;margin:0 auto;padding:32px;background:#0a0a1a;color:#e2e8f0">
        ...
        <table style="width:100%;border-collapse:collapse;margin:20px 0">
          ...
          <tr style="border-bottom:1px solid #1e293b">
            ...
            <td style="padding:10px 8px;text-align:center;color:#4ade80;font-weight:600">✅</td>
          </tr>
          <tr style="border-bottom:1px solid #1e293b">
        ...
        <div style="background:#1e1b4b;border:1px solid #7c3aed;padding:16px 20px;border-radius:8px;margin:20px 0">
          <p style="margin:0;font-size:15px;color:#c4b5fd">💡 <strong>The referral maths:</strong> Refer one business to MansaMusaAI on Professional (£149/mo) and you earn £30/mo recurring. Refer 4 → you earn £120/mo back — nearly covering your own plan cost.</p>
        </div>
